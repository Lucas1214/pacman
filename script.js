...
function circleCollidesWithRectangle({
  ...
  return (circle.position.y - circle.radius + circle.velocity.y 
    ...
    rectangle.position.x - padding && circle.position.y + circle.radius + circle.velocity.y 
     ...
     >= rectangle.position.y - padding && circle.position.x - circle.radius + circle.velocity.x <= rectangle.position.x + rectangle.width + padding)
}
